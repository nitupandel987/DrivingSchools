    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row">
            <div class="col-lg-4 p-4">
                <h3 class="h-font fw-bold fs-3 mb-2">Sleek Gear</h3>
                <p>

                <p>
                   Plote no.37, sunrise city, Niwaru Road, Jhotwada, Jaipur
                   </p>
                   <p>Rajasthan</p>
                </p>
            </div>
            <div class="col-lg-4 p-4">
                ...
                <br>
                <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">Trainig</a>
                <br>
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Designed and developed by Hack Code Team</h6>
